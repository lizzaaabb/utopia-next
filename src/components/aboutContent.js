// aboutContent.js — All static text/data for the About page
...
export const content = {
  eng: {
    ...
    cards: [
      ...
      { text: 'Utopia is more than just a name — it\'s a philosophy. Inspired by the concept of the "ideal city", we offer an experience where comfort, elegance, and professionalism come together.' },
      { title: 'Who We Are', text: 'Utopia is a licensed Georgian company specializing in premium tourism services and high-value real estate investment, tailored for visitors and investors from the Gulf region.' },
      { title: 'What Does "Utopia" Mean?', text: '"Utopia" refers to the perfect place — harmony between people and nature, between rest and precision, between pleasure and investment.' },
    ],
  ...
  geo: {
    ...
    cards: [
      ...
      { text: 'იუტოპია მხოლოდ სახელი კი არა, არამედ ფილოსოფიაა — შთაგონებული "იდეალური ქალაქის" ცნებით, სადაც კომფორტი, ესთეტიკა და პროფესიონალიზმი ერთიანდება.' },
      { title: 'ვინ ვართ ჩვენ', text: '"იუტოპია" არის ლიცენზირებული ქართული კომპანია, რომელიც სპეციალიზებულია პრემიუმ ტურისტულ მომსახურებებსა და უძრავი ქონების ინვესტიციებზე.' },
      { title: 'რას ნიშნავს "იუტოპია"?', text: '"იუტოპია" ნიშნავს იდეალურ ადგილს — ჰარმონიის სივრცეს ადამიანსა და ბუნებას შორის, დასვენებასა და მოწესრიგებულობას შორის.' },
    ],
    tourismTitle: 'ჩვენი ტურისტული სერვისები',
    tourismServices: [
      'ინდივიდუალური ტურისტული პაკეტები ოჯახებისთვისა და სოლო მოგზაურებისთვის',
    ...
    closingText: '"იუტოპია" არ არის უბრალოდ მოგზაურობა ან ქონება — ეს არის კარიბჭე ახალი ცხოვრების სტილისკენ. დაგვიკავშირდით დღეს და დაიწყეთ თქვენი გზა საქართველოში.',
    contactBtn: 'დაგვიკავშირდით',
  },
  ara: {
    title: 'معلومات عنا',
    ...
    cards: [
      ...
      { text: 'يوتوبيا ليست مجرد اسم، بل فلسفة. مستوحاة من مفهوم "المدينة الفاضلة"، حيث تتجسد الراحة، الجمال، والنظام في تجربة متكاملة.' },
      { title: 'من نحن', text: 'يوتوبيا هي شركة جورجية مرخصة، متخصصة في تقديم خدمات سياحية فاخرة وتجهيز فرص استثمار عقاري ذكي، تستهدف الزوّار والمستثمرين من دول الخليج.' },
      { title: 'ما معنى "يوتوبيا"؟', text: '"يوتوبيا" تعني "المدينة المثالية"، حيث يسود الانسجام بين الإنسان والطبيعة، بين الراحة والاحتراف، بين المتعة والاستثمار.' },
    ],
    ...
    closingText: 'يوتوبيا… ليست مجرد رحلة أو عقار، بل بوابتك نحو أسلوب حياة مختلف. تواصل معنا اليوم، وابدأ قصتك في جورجيا مع يوتوبيا',
